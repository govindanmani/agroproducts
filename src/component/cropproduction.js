...
function Cropproduction() {
    ...
    useEffect(() => {
        const api = 'http://localhost:8080/vegetables/cropproduction';
        axios.get(api)
            .then(response => {
    ...
    const handlesubmit =(id)=>{
        navigate(`/product/cropproduction/${id}`);
    }
    ...
    return (
        ...
        {selectedItem && (
                ...
                >
                    ...
                    <img src={selectedItem.img} alt={selectedItem.data} className="modal-img" style={{height:"280px",marginLeft:"30px"}} />
